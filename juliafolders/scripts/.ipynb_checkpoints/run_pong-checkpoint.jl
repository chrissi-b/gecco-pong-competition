...
SEEDS_UPPERLEFT = [2, 6, 10, 13, 18, 22, 26]
SEEDS_LOWERLEFT = [4, 8, 12, 16, 20, 24, 28, 30]
SEEDS_LEFT = [SEEDS_UPPERLEFT; SEEDS_LOWERLEFT]

SEEDS_UPPERRIGHT = [1, 5, 9, 14, 17, 21, 25]
SEEDS_LOWERRIGHT = [3, 7, 11, 15, 19, 23, 27, 29]
