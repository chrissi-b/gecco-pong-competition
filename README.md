...
This repository runs on Linux (Debian, Ubuntu°. To prevent errors that might occur with the opencv library that will be installed in the following step, this code can help:
```shell
